...
<div align="center">
  ...
  <h3><b>3D Product Rendering Site</b></h3>
...
```sh
  cd my-folder
  git clone https://github.com/over-geek/3d-product-render.git
```
--->
...
I would like to thank JavaScript Mastery for the help in getting it done.
